module.exports = {
  ...
  "locations": [
    ...
    },
    {
      ...
      "location": [
        ...
        {
          "name": "Ibis",
          "url": "http://www.ibis.com/gb/hotel-6444-ibis-brighton-city-centre-station/index.shtml",
        ...
        {
          "name": "Old Ship Hotel",
          "url": "http://www.thehotelcollection.co.uk/hotels/old-ship-brighton-hotel/",
          "detail": "from £82",
    ...
    },
    {
      ...
      "location": [
        ...
        {"name": "The Joker", "detail": "wings & salt beef", "url": "http://goo.gl/VNUwb"},
        {"name": "Green Kitchen", "detail": "vegan food", "url": "http://www.greenkitchenbrighton.com/"},
        {"name": "Fatto O Mano", "url": "http://www.fattoamanopizza.com/locations/", "detail": "pizza"},
        { "name": "Cafe Plenty", "detail": "very near to venue", "url": "http://www.cafeplentybrighton.co.uk/" }
      ]
    }
  ],
  "sponsors": {
  ...
  "sessions": {
    "sessions": [
      ...
      },
      {
        ...
        "description": "The Web's evolving. That's nothing new - it's always done that. But now it's going to more and more people, in Africa, Asia, on weird and wonderful devices over weird and unwonderful networks. Meanwhile, frameworks spring up faster than dung beetles on a fresh poo; the CSS folks hate the React gang who hate the Angular crew. Yet we all want to make the web better - but what do we need it to be like? Let's look at the needs and challenges of the next 4 billion consumers, and work out what to do next.",
        "bio": "",
        "links": [],
        "slides": "",
        "audio": "",
      ...
      "topics" : [
        {
          ...
          "description": "Create your first fully SSR Next.js application. Compose layouts and head elements."
        },
        {
          "title": "Extending: custom routing, parameters",
          "description": "Clean and custom URLs, mapping params, environment variables, and more."
        },
        {
  ...
  "quotes": [
    ...
    {
      "text": "Last Friday was my first #ffconf - was blown away by the quality and variety of talks. Fantastic achievement from the conf team",
    ...
    {
      "text": "As I head home, thank you, again to @rem, @julieanne and the volunteers for @ffconf. Incredible event and I felt incredibly taken care of.",
    ...
    {
      "text": "Back home & wondering where to start with all the inspiration I got whilst at #ffconf. Thank you @julieanne & @rem for an excellent day.",
    ...
    {
      "text": "Fantastic set of speakers, interesting and exciting topics, great day @ffconf. Thanks and congratulations to @rem and @julieanne",
      "author": "Phil Nash, developer evangelist for Twilio",
      "url": "https://twitter.com/philnash/status/530777197607682048",
      "photo": "phil-nash.jpg"
    },
    {
      "text": "#ffconf is a wrap: what a truly inspirational event with so many interesting topics. Glad that I finally was able to attend.",
      "author": "Robin Mehner, 2015 speaker",
      "url": "https://twitter.com/rmehner/status/662700722107084800",
      "photo": "robin-mehner.jpg"
    },
    {
      "text": "Yes! #ffconf was amazing. Had an inspiring day listening to awesome people, talking about super interesting stuff. Almost too good.",
    ...
    {
      "text": "Must be the most comfy seats of any conference I attended - so glad I finally made it - #ffconf",
    ...
    {
      "text": "I can pinpoint ffconf talks, which have changed the way I approach web development and the tools I use. That's why every year it has an unmovable place in my calendar.",
      "author": "Glenn Jones, co-founder of Madgex & 2011 speaker",
      "url": "https://twitter.com/glennjones",
      "photo": "glenn-jones.jpg"
    },
    {
      "text": "Practical, inspiring & progressive - its rare a tech conference delivers on all of them but @ffconf pulls it off. Quality gig 👌",
    ...
    {
      "text": "Not sure how many juniors went to #ffconf but I feel honoured to be one of them. Great conference & superb inspiring talks! Bring it on ffconf 2016",
